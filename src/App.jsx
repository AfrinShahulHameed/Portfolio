...
<section id="work" className="px-6 py-16">
  ...
  <div className="max-w-6xl mx-auto">
   ...
   <SectionHeading>Featured Work</SectionHeading><br></br><br></br>
    ...
    <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      {[
        ...
        },
        {
          ...
          tag: "Hackathon",
          desc: "Explored decentralized systems and built secure workflow prototypes during a competitive 24-hour hackathon.",
        },
        {
    ...
    >
      ...
      <p className="mt-5 text-center text-xs text-gray-500">
        ...
        <a
          ...
          className="text-[#c084fc] underline underline-offset-4 hover:text-[#e0b4ff]"
        >
